        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 pb-20 md:pb-28">
          ...
          <div className="flex items-center gap-5 flex-wrap">
            ...
            <div className="flex items-center gap-4">
              <a href="http://instagram.com/tannedco_" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/70 hover:text-white transition-colors">
              ...
              <a href="https://www.tiktok.com/@tannedco_" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-white/70 hover:text-white transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
              ...
              <a href="https://www.facebook.com/profile.php?id=100086326464692" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/70 hover:text-white transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
